...
class _TrimSliderState extends State<TrimSlider>
  ...
  Rect _rect = Rect.fromLTRB(301.0, 0.0, 381.5, 60.0);
  ...
  void initState() {
    ...
    super.initState();
    // setState(() {
    //   _rect = Rect.fromLTRB(174.5, 0.0, 338.0, 60.0);
    //   print(_rect);
    // });
  }
  ...
  void _createTrimRect() {
    //TODO: ここが初期値（ここをいじればトリムの初期位置を変更できる）
    // _rect = Rect.fromLTRB(301.0, 0.0, 381.5, 60.0);
