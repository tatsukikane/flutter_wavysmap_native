...
class video_dialog extends StatefulWidget {
  //カルーセルに対応する動画のデータを取得
  final videodeta;
  video_dialog({Key? key, required this.videodeta}) : super(key: key);

  @override
  State<video_dialog> createState() => _video_dialogState();
}

class _video_dialogState extends State<video_dialog> {
